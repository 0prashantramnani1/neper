...
nflows     = [1000, 5000, 10000, 15000, 20000, 30000, 40000, 50000, 75000, 100000, 200000, 500000, 750000, 1000000]
# nthreads  = "1"
nthreads  = [30, 50, 75]
# nthreads  = [25, 50, 75]
# nthreads = [50, 75]
                ...
                while i < 3:
                    ...
                    try:
                        ...
                        if client_threads >= 50:
                            tm.sleep(timeout)
                        tm.sleep(5)
                        process = subprocess.check_output([su, command, client, host, host_ip, f_command, str(flows), t_command, str(threads), numports_command, str(client_threads)], timeout=1500)
