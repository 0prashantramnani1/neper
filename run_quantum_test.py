...
file1 = open("quantum_sheet_large_hash.txt", "a")
...
for ts in time_quantum:
    ...
    for f, t in nflows.items():
        ...
        file1.write("time_quantum {} Flows {} client_threads {} avg_throughput {} standard_deviation {} Max {} Min {}\n".format(ts, f, t, mean, variance ** 0.5, max(avg), min(avg)))
        file1.flush()
